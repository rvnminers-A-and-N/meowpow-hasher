...
union ethashprime_hash256 ethashprime_keccak256(const uint8_t* data, size_t size)
{
    union ethashprime_hash256 hash;
    keccak(hash.word64s, 256, data, size);
    return hash;
}

union ethashprime_hash256 ethashprime_keccak256_32(const uint8_t data[32])
{
    union ethashprime_hash256 hash;
...
union ethashprime_hash512 ethashprime_keccak512(const uint8_t* data, size_t size)
{
    union ethashprime_hash512 hash;
    keccak(hash.word64s, 512, data, size);
    return hash;
}

union ethashprime_hash512 ethashprime_keccak512_64(const uint8_t data[64])
{
    union ethashprime_hash512 hash;
