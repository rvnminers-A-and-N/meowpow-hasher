...
const ethashprime_epoch_context* ethashprime_get_global_epoch_context(int epoch_number) noexcept
{
...
const ethashprime_epoch_context_full* ethashprime_get_global_epoch_context_full(int epoch_number) noexcept
{
    // Check if local context matches epoch number.
