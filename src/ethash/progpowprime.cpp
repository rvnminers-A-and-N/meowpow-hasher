// ethashprime: C/C++ implementation of Eprimethashprime, the Ethereum Proof of Work algorithm.
...
namespace
{
/// A variant of Keccak hash function for Progpowprime.
///
...
void keccak_progpowprime_256(uint32_t* st) noexcept
{
    ethashprime_keccakf800(st);
}

/// The same as keccak_progpowprime_256() but uses null mix
/// and returns top 64 bits of the output being a big-endian prefix of the 256-bit hash.
inline void keccak_progpowprime_64(uint32_t* st) noexcept
{
    keccak_progpowprime_256(st);
}
